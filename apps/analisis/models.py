...
class AnalisisNutricional(models.Model):
    ...
    ESTADO_CHOICES = [
        ...
        (1, 'Sobrenutrido'),
        (2, 'Normal'),
        (999, 'Procesando'),  # Estado temporal mientras se procesa
    ]
    ...
    # Resultados de la inferencia - PERMITIR NULOS TEMPORALMENTE
    estado_nutricional = models.IntegerField(
        choices=ESTADO_CHOICES, 
        default=999,  # Estado "Procesando" por defecto
    ...
    # Campos para indicar el estado del procesamiento
    ...
    def marcar_error_procesamiento(self, error_mensaje):
        ...
        self.estado_nutricional = 2  # Normal por defecto si hay error
        self.confianza = 0.0
        self.save()
    
    def _generar_recomendaciones(self):
        """Genera recomendaciones basadas en el estado nutricional"""
        # Solo generar si el procesamiento está completado
        ...
        if self.estado_nutricional == 0:  # Malnutrido
        ...
        elif self.estado_nutricional == 1:  # Sobrenutrido
            recomendaciones['alimentarias'] = [
        ...
        elif self.estado_nutricional == 2:  # Normal
            recomendaciones['alimentarias'] = [
